...
const project = [
    ...
    {title:"Food app", subtitle:"An application that helps you to cook, with instructions, pictures, ingredients, and more. A site where you can search by keyword, by diet and even sort by score and alphabetically, and then you can add to your wish list any that you most like. Also you can submit your recipe and share it.", image: require('../../assets/food_app.png'), id:'food', url:'http://letscook-app.vercel.app', tech:['javascript','react','redux','node','express','sequelize','cssmodules','html5','postgresql']},
    {title:"Weather app", subtitle:"an application where you can search cities or countries of the world to know the weather in real time. You can add or remove at the home that you dont need any more. ", image: require('../../assets/weather_app.png'), id:'weather', url:'http://finder-app-omega.vercel.app', tech:['javascript','react','cssmodules','html5']}
]
