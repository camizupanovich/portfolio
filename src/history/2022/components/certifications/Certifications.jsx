...
export default function Certifications({dark}){
    return(<>
        <div className={dark? s.containerD :s.container}>
           ...
           <a className={s.ahref} href='https://certificates.soyhenry.com/cert?id=05659892-1401-4e89-b63c-70139bd4045f' target='_blank'><img className={s.paper} src={henry} alt='henry'/></a>
