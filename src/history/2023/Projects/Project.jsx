...
export default function Project({ data, backgroundColorPrimary, backgroundColorSecondary, fontColor, textOposite, blurBgColor }) {
    ...
    return (
        <>
            <div style={{ width: '100vw', height: '78vh', backgroundImage: 'url("https://webbtanten.se/wp-content/uploads/2018/12/webbtanten-att-skriva-768x461.jpg")', backgroundAttachment: 'fixed', backgroundSize: 'cover', backgroundRepeat: 'no-repeat', display: 'flex', alignItems: 'center', flexDirection: 'row', position: 'relative' }}>
